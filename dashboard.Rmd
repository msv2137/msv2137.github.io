...
weather_df %>%
  ...
  layout(title = "Total Precipitation per Month in Waikiki, HI", xaxis = list(title = "Month"), yaxis = list(title = "Precipitation (cm)"))
```
...
weather_df_plot = weather_df %>%
  ...
  facet_wrap(. ~ name) +
  labs(title = "Maximum Temperature Over The Year Per Weather Station", 
       x = "Date", 
